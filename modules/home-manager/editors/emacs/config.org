...
This config wasn't created in a void, so I'd like to acknowledge the resources that helped me get here:
  ...
  - Several articles from Karthinks' blog ([[https://karthinks.com/][Link]])
...
| PDF Tools               | Better PDF support                        |          |
| Citar                   | Citation management                       |          |
| LilyPond/Lyqi           | LilyPond support                          |          |
| ERC                     | IRC client                                | l i      |
| Emacs-Jabber            | XMPP client                               | l x      |
| Ement                   | Matrix client                             | l E      |
| Olivetti                | Word processing                           |          |
| Jinx/FlySpell           | Spell checking                            |          |
| Ledger-Mode/Org Ledger  | Accounting                                |          |
| Wgrep                   | Writeable grep for versatile mass editing |          |
| Beacon/Pulsar           | Flash screen motions                      |          |
...
** Fonts
I use [[https://github.com/be5invis/iosevka][Iosevka]] as my font of choice.
...
Can this be installed via Elpaca? No.
...
** TODO Org Fonts
Org needs special font treatment, given the fact that it's not really code.
